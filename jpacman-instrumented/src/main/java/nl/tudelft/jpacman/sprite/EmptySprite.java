package nl.tudelft.jpacman.sprite;import coverageApi.Collect;import java.awt.Graphics; public class EmptySprite implements Sprite {
	...
	@Override
	public void draw(Graphics g, int x, int y, int width, int height) {Collect.Hit("EmptySprite.java","draw(Graphics g, int x, int y, int width, int height)");Collect.Hit("EmptySprite.java","draw(Graphics g, int x, int y, int width, int height)", "4972");}
