package nl.tudelft.jpacman.sprite;import coverageApi.Collect;import java.awt.Graphics; public class AnimatedSprite implements Sprite {
	 ...
	 */
	public AnimatedSprite(Sprite[] frames, int delay, boolean loop) {this(frames, delay, loop, false);Collect.Hit("AnimatedSprite.java","AnimatedSprite(Sprite[] frames, int delay, boolean loop)");Collect.Hit("AnimatedSprite.java","AnimatedSprite(Sprite[] frames, int delay, boolean loop)", "5012");}
