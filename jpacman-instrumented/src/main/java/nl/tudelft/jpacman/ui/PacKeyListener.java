...
import java.util.Map; class PacKeyListener implements KeyListener {
	...
	@Override
	public void keyTyped(KeyEvent e) {Collect.Hit("PacKeyListener.java","keyTyped(KeyEvent e)");Collect.Hit("PacKeyListener.java","keyTyped(KeyEvent e)", "5012");}
	
	@Override
	public void keyReleased(KeyEvent e) {Collect.Hit("PacKeyListener.java","keyReleased(KeyEvent e)");Collect.Hit("PacKeyListener.java","keyReleased(KeyEvent e)", "5012");}
}